        ...
        >
          <div className="space-y-2">
            ...
            <p className="text-lg text-custom-light/80 max-w-2xl leading-relaxed">
              Thank you for participating in the Bulbasaur Cards mint! You can now check your profile to view and open your packs.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12">
          ...
          >
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-custom-light">Collection Stats</h2>
